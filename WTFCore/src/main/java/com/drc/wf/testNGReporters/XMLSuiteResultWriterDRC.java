...
public class XMLSuiteResultWriterDRC 
{

	 private XMLReporterConfig config;
	 private Boolean writePassed;
	 private Boolean writeFailed;
	 private Boolean writeSkipped;
	 
	 
	public XMLSuiteResultWriterDRC(XMLReporterConfig config, Boolean passed, Boolean failed, Boolean skipped) {
